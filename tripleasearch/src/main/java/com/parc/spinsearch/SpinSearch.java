...
public static final String USER_AGENT = "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/535.1 (KHTML, like Gecko) Chrome/13.0.782.112 Safari/535.1";
	...
	public ArrayList <ArrayList<String>> getArtistList(String artistInputPath){
		String line = null;
		ArrayList<ArrayList<String>> artistInfo = new ArrayList<ArrayList<String>>(); 
		...
		try
		{
			...
			while ((line = artistReader.readLine()) != null && line.trim().length() > 0)
			{
				...
				addArtistNames(line, artistInfo);
	...
	public static void addArtistNames(String line, ArrayList<ArrayList<String>> artistInfo) {
	...
	public void spinSearch(String url, ArrayList<ArrayList<String>> artistInfo, String outputPath, String inputPath) throws Exception {
		Map<String, ArrayList <String>> spinsByArtist = getSpins(url, artistInfo, outputPath, inputPath);
		outputSpinsByArtist(outputPath, spinsByArtist);
	}
	...
	public Map<String, ArrayList <String>> getSpins(String url, ArrayList <ArrayList<String>> artistInfo, String outputPath, String inputPath) throws Exception {
	...
	public ArrayList<ArrayList<String>> getSpinData(ArrayList<String> currentArtist, String url, String inputPath) {
		...
		String artistUrl = insertString("//a[@href='artists.aspx?rid=']", currentArtist.get(0), 26);
